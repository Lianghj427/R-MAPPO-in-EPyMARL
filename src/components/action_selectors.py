...
from .epsilon_schedules import SRDecayThenFlatSchedule, DecayThenFlatSchedule
...
class SoftEpsilonGreedyActionSelector():
    ...
    def __init__(self, args):
        ...
        self.schedule = SRDecayThenFlatSchedule(args.epsilon_start, args.epsilon_finish, args.epsilon_anneal_time,
