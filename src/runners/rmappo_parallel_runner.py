...
from envs import register_smacv2
...
class ParallelRunner:
    ...
    def __init__(self, args, logger):
        ...
        # set different seed for each env
        ...
        if "prey_wrapper" in self.args.env_args and self.args.env_args["prey_wrapper"] == "PretrainedTag":
    ...
    def reset(self):
        ...
        for parent_conn in self.parent_conns:
            ...
            pre_transition_data["alive_agents"].append(data["alive_agents"])
...
def env_worker(remote, env_fn):
    ...
    while True:
        ...
        if cmd == "step":
            ...
            obs = env.get_obs()
            alive_agents = env.get_alive_agent()
            remote.send({
